"""Initial schema frozen from e9a5883; never import live app models here.

Later revisions own all subsequent schema additions. Changing app.db must not
change what a fresh database looks like at revision 0001.
"""
