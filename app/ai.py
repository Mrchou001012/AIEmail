...
"DEMO-P100 100 kg and DEMO-P500 200 kg" becomes two product_requests entries). A product
...
If identity is ambiguous or evidence conflicts, say so. Do not choose a Example product category in
this research step."""
...
- NON_TARGET: the sender explicitly identifies their organization as a logistics provider, freight
  forwarder, customs broker, supplier/vendor selling to Example Chemicals, or other service vendor rather
...
that role when the same new message asks Example Chemicals for a product catalogue, quotation, availability,
or another purchasing response; use BUSINESS unless the message clearly offers unrelated goods or
services to Example Chemicals instead. A supplier-registration pitch, product sales introduction, or explicit
...
true only when the new message actually asks Example Chemicals to provide a list/catalog; statements such
