...
from app.common.email_identity import reply_contact_name
from app.db import (
    AgentRun,
    AgentStep,
    AssistanceRequest,
...
from app.dispositions.disposition_resolution import same_company_domain as _same_company_domain
...
async def _stage_referral_outreach(
    ...
    *,
    ...
    subject = "Example Chemicals product contact"
    business_text = (
        "Dear Sir/Madam,\n\n"
        "The previous contact at your company directed future correspondence to "
        "this address. This is Demo Agent from Example Chemicals.\n\n"
