...
from app.inbound.auto_replies import (
    AutomatedReplyType,
...
def _non_target_explanation(reason: str) -> str:
    return {
        ...
        "SUPPLIER_VENDOR": (
            "sender explicitly offers goods or supplier registration to Example Chemicals"
        ),
        "SERVICE_PROVIDER": (
            "sender explicitly offers unrelated professional services to Example Chemicals"
        ),
