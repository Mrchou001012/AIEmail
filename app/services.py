...
from app.deliverability import lookup_mx, validate_address_format
from app.delivery_safety import (
    _email_address_status,
    _ensure_customer_contact,
    _lock_recipient_delivery_gate,
    _suppress_email_address,
    recipient_preflight,
)
from app.delivery_safety import (
    add_customer_contact_endpoint as add_customer_contact_endpoint,
)
from app.delivery_safety import (
    replace_handoff_recipient as replace_handoff_recipient,
)
from app.delivery_safety import (
    resolve_deliverability_handoff as resolve_deliverability_handoff,
)
from app.delivery_safety import (
    suppress_contact_endpoint as suppress_contact_endpoint,
)
