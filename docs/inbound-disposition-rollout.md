...
grep -E \
'^(AUTO_SEND_ENABLED|IMAP_SYNC_ENABLED|INBOUND_DISPOSITION_ENABLED|INBOUND_DISPOSITION_APPLY_ENABLED|REFERRAL_AUTO_CONTACT_ENABLED)=' \
...
grep -E \
'^(INBOUND_DISPOSITION_ENABLED|INBOUND_DISPOSITION_APPLY_ENABLED|REFERRAL_AUTO_CONTACT_ENABLED)=' \
/etc/aiemail/aiemail.env
```
